...
public class AlphaBetaEvaluationSimpleWithCompleteReadingAI extends AlphaBetaEvaluationSimpleAI {
    private final int completeReadingThreshold;
    
    public AlphaBetaEvaluationSimpleWithCompleteReadingAI(Turn turn, int maxDepth, int completeReadingThreshold) {
        super(turn, maxDepth);
